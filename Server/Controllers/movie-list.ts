...
{
  res.render('index', { title: 'Add', page: 'movie-edit', movie: '', displayName:  UserDisplayName(req) })
}
...
export function DisplayEditPage(req: express.Request, res: express.Response, next: express.NextFunction): void 
{
  ...
  Movie.findById(id, {}, {}, function(err, movieToEdit)
  {
    ...
    res.render('index', { title: 'Edit', page: 'movie-edit', movie: movieToEdit, displayName:  UserDisplayName(req) })
  });
}
