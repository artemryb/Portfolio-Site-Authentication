...
function DisplayAddPage(req, res, next) {
    res.render('index', { title: 'Add', page: 'movie-edit', movie: '', displayName: (0, Util_1.UserDisplayName)(req) });
}
...
function DisplayEditPage(req, res, next) {
    ...
    movie_1.default.findById(id, {}, {}, function (err, movieToEdit) {
        ...
        res.render('index', { title: 'Edit', page: 'movie-edit', movie: movieToEdit, displayName: (0, Util_1.UserDisplayName)(req) });
    });
}
